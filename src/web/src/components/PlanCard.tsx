  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-6">
        <div className={`w-16 h-16 bg-gradient-to-br ${gradientColor} rounded-full flex items-center justify-center mx-auto mb-4`}>
        ...
        <div className="mb-6">
          {isEnterprise ? (
            <div className="text-foreground">
              ...
              <div className="text-sm text-foreground-secondary">Contattaci per un preventivo</div>
            </div>
          ) : (
            <div className="text-foreground">
              ...
              {!isFree && (
                <div className="text-sm text-foreground-secondary">
                  o €{plan.price.yearly}/anno (risparmia €{(plan.price.monthly * 12) - plan.price.yearly})
                </div>
              )}
            </div>
          )}
      ...
      <div className="bg-background rounded-lg p-4 mb-6 space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2 text-sm">
          ...
          <div>
            ...
            <span className="text-foreground font-medium ml-1">
              {plan.limits.maxUsersPerWorkspace + plan.limits.maxCollaboratorsPerWorkspace}
            </span>
          </div>
      ...
      >
        {isCurrentPlan 
          ? (isTrialPro ? 'Trial in corso' : 'Piano attuale')
          : plan.cta
        }
      </button>
